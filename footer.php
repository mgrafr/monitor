...
if (document.getElementById('onoffmur').checked==true) {arret_mur=1;updateImage(nbrCam);document.getElementById('aqw').innerHTML=" Vidéo active sur toutes les caméras";}
