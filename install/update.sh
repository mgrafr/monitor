...
apt install unzip
if [ "$vermon" = "Version 400 ] && [ "$answer" -gt 323 ] && [ "$answer" -ne 400 ]; then
    echo "mise a jour vers 4.0.0"
    wget https://raw.githubusercontent.com/mgrafr/monitor/main/install/maj_400.sh
    dos2unix maj_400.sh
    chmod +x maj_400.sh 
    ./maj_400.sh
 elif [ "$vermon" =  "Version 4.0.0" ] && [ "$answer" -eq 324 ]; then 
    echo "mise a jour vers 4.0.0"
    wget https://raw.githubusercontent.com/mgrafr/monitor/main/install/maj_324.sh
    dos2unix maj_324.sh
    chmod +x maj_324.sh 
    ./maj_324.sh
 elif [ "$vermon" =  "Version 4.0.0" ] && [ "$answer" -eq 400 ]; then  
     echo "deja a jour"
