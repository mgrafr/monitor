...
require_once("PragmaRX/Google2FA/Exceptions/InvalidAlgorithmException.php");
require_once("PragmaRX/Google2FA/Exceptions/SecretKeyTooShortException.php");
require_once("PragmaRX/Google2FA/Support/Base32.php");
require_once("PragmaRX/Google2FA/Support/Constants.php");
require_once("PragmaRX/Google2FA/Support/QRCode.php");
