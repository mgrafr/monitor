...
<div id="interieur" >
	<div class="container">
	  ...
	  <h1 id="about" class="title text-center">Dispositifs<span> installés<br>à l'intérieur</span></h1><br><p>DEMO</p>
		<div class="space"></div>
         <?php include ("../include/new_maison_svg.php");echo '<p id="decouv_int"> Cette page est une page de démonstration , pour utiliser le mode normal , dans /admin/config passer la variable DECOUVERTE sur false<br>
