<body>
    ...
    <!-- header start -->
		...
		<div class="site-slogan"><?php echo NOMSLOGAN;?></div></div>
...
<div class="modal" id="lexique">
  <div class="modal-dialog" style="height:auto;width: 300px;">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Infos</h3>
			 ...
			 <p style="margin-left:10px"><img class="info1" src="images/poubelle_grise.svg" style="width:40px;height:auto;" >poubelle ménagère
			 <img class="info1" src="images/poubelle_grise_v.svg" style="width:40px;height:auto;" ></p>
			 <p style="margin-left:10px"><img class="info1" src="images/poubelle_jaune.svg" style="width:40px;height:auto;" >poubelle recyclabes
			 <img class="info1" src="images/poubelle_j_videe.svg" style="width:40px;height:auto;" ></p>
			 <p style="margin-left:10px"><img class="info1" src="images/fosse_septique.svg" style="width:40px;height:auto;" >fosse septique à traiter</p>
			 <p style="margin-left:10px"><img class="info1" src="images/pluie.svg" style="width:40px;height:auto;" >averse pluie imminente</p>
			 <p style="margin-left:10px"><img class="info1" src="images/anni.svg" style="width:40px;height:auto;" >anniversaires<img class="info1" src="images/alarme_enable.svg" style="width:40px;height:auto;" >Alarme Nuit</p>
			 <p style="margin-left:10px"><img class="info1" src="images/batterie_faible.svg" style="width:30px;height:auto;" ><img class="info1" src="images/batterie_moy.svg" style="width:30px;height:auto;" >niveau bas des piles</p>
			 <p style="margin-left:10px"><img class="info1" src="images/ping_pi4.svg" style="width:40px;height:auto;" >PI4 hors service</p>
