...
require_once("PragmaRX/Google2FA/Exceptions/IncompatibleWithGoogleAuthenticatorException.php");
require_once("PragmaRX/Google2FA/Exceptions/InvalidCharactersException.php");
require_once("PragmaRX/Google2FA/Exceptions/SecretKeyTooShortException.php");
require_once("PragmaRX/ConstantTime/Base32.php");
