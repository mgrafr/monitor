  ...
  <div class="container">
    <div class="col-md-12">
      ...
      <p id="admin4">
        ...
        <img src="images/serveur-sql.svg" style="width:30px">
        <a class="admin1" href="#admin" rel="9" title="reponse1" >Test Base de données</a><br>
		<img src="images/iobroker.svg" style="width:30px">
        <a class="admin1" href="#admin" rel="26" title="reponse1" >Test Adaptateur io.Broker</a><br>  
