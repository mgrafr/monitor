...
<div id="administration">
  ...
  <div class="column is-11" style="margin-left:7%">
    ...
    margin-left:-15px;">Mots passe IP réseau</button><img class="btn_appd space5" src="images/icon-info.svg" rel="info_adm" title="6" data-titre="Mots de passe & IP""><br>'; 
         if (ECRAN_ADMIN['string_tableaux']=="enable")echo '<button type="button" class="button is-link is-light btn_appd but2" rel="admin" title="3" data-titre="Configuation variables de maj_services" >Configuation variables dz maj_services</button><img class="btn_appd" src="images/icon-info.svg" data-titre="Configuation variables de maj_services" rel="info_adm" title="5""><br>';
        ...
        if (ECRAN_ADMIN['idx_dz_list']=="enable")echo '<button type="button" class="button is-link is-light btn_appd but3" rel="admin" title="12" data-titre="fichier idx/nom Domoticz">Créer fichier idx/nom Domoticz , LISTE</button><img class="btn_appd space5" src="images/icon-info.svg" data-titre="Exemple fichier idx/nom Domoticz" rel="info_adm" title="3""><br>';
        ...
        <button type="button" class="button is-link is-light btn_appd but12" rel="admin" title="17" data-titre="Enregistrer ou modifier Variables">Enregistrer ou modifier Variables dans SQL&nbsp;</button><img class="btn_appd space30" src="images/icon-info.svg" data-titre="Enregistrer ou modifier Variables" rel="info_adm" title="0""><br>
        <button type="button" class="button is-link is-light btn_appd but11" rel="admin" title="18" data-titre="Enregistrer ou modifier Dispositifs">Enregistrer ou modifier Dispositifs dans SQL&nbsp;</button> <img class="btn_appd" src="images/icon-info.svg" rel="info_adm" data-titre="Enregistrer ou modifier Dispositifs" title="7""><br>
        <button type="button" class="button is-link is-light btn_appd but10" rel="admin" title="25" data-titre="Enregistrer Message DZ( ou HA) dans SQL">Enregistrer Message DZ ou HA dans SQL</button> <img class="btn_appd" src="images/icon-info.svg" rel="info_adm" data-titre="Enregistrer Message DZ( ou HA) dans SQL" title="9""></P>
