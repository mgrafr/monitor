  ...
  <div class="container">
    <div class="col-md-12">
      ...
      <p id="admin4">
		...
		if (ECRAN_ADMIN['mod_py_list']=="enable")echo '<a class="admin1" href="#admin" rel="19" title="reponse1" >LISTE module Python</a> <a><img class="info_admin" src="images/icon-info.svg" data-toggle="modal" data-target="#info-admin1" rel=11 style="width:25px;display:inline;"></a><br>';  
