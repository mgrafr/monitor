...
<div id="administration">
  ...
  <div class="column is-11" style="margin-left:7%">
      ...
      <P class="top-30"><button type="button" id="admin3" class="button is-link is-light btn_appd" rel="admin" title="5" data-titre="Configuration Monitor" >Configuation monitor</button><img class="btn_appd space10" src="images/icon-info.svg" rel="info_adm" title="1" data-titre="Configuration Monitor"">
      </p>
    ...
    margin-left:-15px;">Mots passe IP réseau</button><img class="btn_appd space5" src="images/icon-info.svg" rel="info_adm" title="6" data-titre="Mots de passe & IP""><br>'; 
         if (ECRAN_ADMIN['string_tableaux']=="enable")echo '<button type="button" class="button is-link is-light btn_appd but2 but13" rel="admin" title="3" data-titre="Configuation variables dz" >Configuation variables dz </button><img class="btn_appd space5" src="images/icon-info.svg" data-titre="Configuation variables" rel="info_adm" title="5""><br>';
        ...
        <button type="button" class="button is-link is-light btn_appd but6" rel="admin" title="9" data-titre="Test Base de données">Test Base de données</button><br>
		    <button type="button" class="button is-link is-light btn_appd but5" rel="admin" title="14" data-titre="Sauvegarde <br>Base de données">Sauvegarde Base de données</button><br>
        ...
        <button type="button" class="button is-link is-light btn_appd but11" rel="admin" title="18" data-titre="Enregistrer ou modifier Dispositifs">Enregistrer ou modifier Dispositifs dans SQL&nbsp;</button> <img class="btn_appd space5" src="images/icon-info.svg" rel="info_adm" data-titre="Enregistrer ou modifier<br> Dispositifs" title="7""><br>
        <button type="button" class="button is-link is-light btn_appd but10 but14" rel="admin" title="25" data-titre="Enregistrer Message DZ ou HA dans SQL">Enregistrer Message DZ ou HA dans SQL</button> <img class="btn_appd space5" src="images/icon-info.svg" rel="info_adm" data-titre="Enregistrer Message <br>DZ ou HA dans SQL" title="9""></P>
