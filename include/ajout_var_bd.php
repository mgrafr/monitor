...
echo '<div id="advf" style="line-height: normal;font-size: 14px;"><form><p style="width:350px;background-color: aquamarine; margin-left: 10px;"><strong>Si mise à jour, num: :</strong><input type="text" style="width:40px;margin-left:10px;" id="num" value=""  ><input type="hidden" id="command2"  value="9"><button id="bouton1_maj" type="button" onclick="adby(6)" style="width:50px;margin-left:10px;height:30px">Envoi</button></p></form></div>
...
<input type="hidden" id="app"  value="var_bd"><input type="hidden" id="command"  value="1">
 ...
 <span style="margin-left: 10px;">nom_objet  :<input type="text" style="width:200px;margin-left: 3px;" id="nom_objet" value="" ></span><br>
