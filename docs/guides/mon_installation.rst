...
.. code-block::
	...
	<div class="main-buttons" style="position: relative;top: 30px;left:50px">
	<div id="w_start"></div>
    	<!--!<div id="w_stop" class="col-6 col-sm-auto text-center py-2"><button class="btn btn-danger"><i class="fa fa-square"></i> Stop</button></div>-->
   	</div>
	<br>	
	...
	if (state=="Off")document.getElementById("w_start").innerHTML='<button id="start_stop" class="btn btn-primary"><i class="fa fa-play"></i> Start</button><button style="margin-left: 10px;" class="btn btn-success"><i class="fa fa-home"></i> Home</button><button style="margin-left: 10px;" class="btn btn-secondary"><i class="fa fa-pause"></i> Pause</button>';
	if (state=="On")document.getElementById("w_start").innerHTML='<button id="start_stop" class="btn btn-danger"><i class="fa fa-square"></i> Stop</button><button style="margin-left: 10px;" class="btn btn-success"><i class="fa fa-home"></i> Home</button><button style="margin-left: 10px;" class="btn btn-secondary"><i class="fa fa-pause"></i> Pause</button>';		
	}
