...
define('DHCAMPASS', array( //id var domoticz, nom var domoticz, %1 (moyen), %2 (faible) de l'energie restante  
    '192.168.1.107' => xxxxxxxxxxxxxxxx',
    '192.168.1.108' => 'xxxxxxxxxxxxxxxxxx',
    '192.168.1.114' => 'xxxxxxxxxxxxxxxxxxxx'
));
define('DHUSER','xxxxxxxxx');
//define('DHPASS','xxxxxxxxxxx');
// --------------------------------------------------------------------------------------------
